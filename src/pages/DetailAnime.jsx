      ...
      {Object.keys(detailAnime).length > 0 && (
        <div className="w-full mt-8 text-slate-950 border-black border-2 shadow-[8px_8px_0px_rgba(0,0,0,1)] bg-[#F2F7F5]">
          ...
          {/* <div className="m-6 mt-8">
            <div className="w-fit px-8 py-4 bg-white border-4 border-black shadow-[8px_8px_0px_rgba(0,0,0,1)] grid place-content-center">
              <div>
                <h1 className="text-2xl mb-4">
                  The message you want goes in here.
                </h1>
