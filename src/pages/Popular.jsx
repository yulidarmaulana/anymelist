    ...
    <>
      ...
      <div className="grid grid-cols-4 gap-4 mb-4">
        {animeData.map((anime) => (
          <div
            key={anime.mal_id}
            className="mt-8 text-slate-950 border-black border-2 hover:shadow-[8px_8px_0px_rgba(0,0,0,1)] bg-[#F2F7F5]"
          >
            <a href="" className="block cursor-pointer">
              <article className="w-full h-full">
                ...
                <div className="px-6 py-5 text-left h-full">
                  ...
                  <p className="text-xs mb-4 line-clamp-4">{anime.rating}</p>
